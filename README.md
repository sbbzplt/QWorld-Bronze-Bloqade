...
**Bronze-Bloqade** is the version of Bronze using [**Bloqade**](https://bloqade.quera.com/latest/) as the quantum programming framework. It was created via modifing [**Bronze-Qiskit**](https://gitlab.com/qworld/bronze-qiskit) by Saba Bozpolat, QTurkiye, in June 2026.
